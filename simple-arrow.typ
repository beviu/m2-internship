// This code comes from the pinit package's
// [source code](https://github.com/OrangeX4/typst-pinit/blob/774460259373940a09fad863490975bf1021fda2/simple-arrow.typ).
...
#let simple-arrow(
  ...
  polygon(
    ...
    (
      start-x + _dx - _s * _hw - _c * _arrow-height,
      start-y + _dy + _c * _hw - _s * _arrow-height,
    ),
    (end-x, end-y),
    (
      start-x + _dx + _s * _hw - _c * _arrow-height,
